...
#define CommandPacket_init_default               {false, CommandOrientation_init_default, {{NULL}, NULL}}
#define TelemetryPacket_init_default             {0, 0, {{NULL}, NULL}}
#define CommandOrientation_init_zero             {0, 0}
#define IdValuePairFloat_init_zero               {0, false, 0}
#define CommandPacket_init_zero                  {false, CommandOrientation_init_zero, {{NULL}, NULL}}
#define TelemetryPacket_init_zero                {0, 0, {{NULL}, NULL}}
...
extern const pb_field_t CommandOrientation_fields[3];
...
#define CommandOrientation_size                  10
#define IdValuePairFloat_size                    11
/* CommandPacket_size depends on runtime parameters */
/* TelemetryPacket_size depends on runtime parameters */
